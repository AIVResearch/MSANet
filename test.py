...
def get_parser():
    ...
    parser.add_argument('--arch', type=str, default='our_model') 
...
def get_model(args):
    ...
    model = torch.load('/home/nvadmin/Few-shot-learning/Our_model_public/Weights/Our_entire_model/pascal/pascal_split0_resnet50_0.6925.pt')
    model = model.cuda()
        ...
        for i, (input, target, target_b, s_input, s_mask, subcls, ori_label, ori_label_b, class_id) in enumerate(val_loader):
            ...
            if Visualizer.visualize and visual:
                Visualizer.visualize_prediction_batch(s_input, s_mask,
                                                      input, target_vis,
                                                      output_vis,meta_out_vis, base_out_vis, class_id, increment, dir_name='ours_pascal_0_test_resnet101/')
